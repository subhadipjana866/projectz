...
export default function Login() {
  ...
  return (
    <div 
      className="min-h-screen flex flex-col items-start w-full"
      style={{
        backgroundImage: `
    ...
    >
      ...
      <div className="backdrop-blur-md bg-[rgba(16,22,34,0.4)] border-b border-[rgba(255,255,255,0.1)] w-full flex items-center justify-between px-20">
        ...
        <button className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-lg p-2.5 hover:bg-[rgba(255,255,255,0.1)] transition-colors">
      ...
      <div className="flex-1 flex items-center justify-center w-full px-4 py-12">
        {/* Login Card */}
        <div className="backdrop-blur-md bg-[rgba(16,22,34,0.4)] border border-[rgba(255,255,255,0.1)] rounded-xl shadow-2xl p-10 w-full max-w-[32rem]">
          {/* Heading */}
          <div className="mb-8">
            <h2 className="text-4xl font-bold text-white mb-2 text-left">Welcome Back</h2>
            <p className="text-slate-400 text-left">Enter your credentials to access your workspace</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email */}
            <div>
              <label className="block text-sm font-medium text-slate-200 mb-2 pl-1 text-left">Email Address</label>
              <input
                type="email"
                value={email}
                ...
                className="w-full px-4 py-3 bg-white text-slate-900 rounded-lg placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1152d4] transition-all"
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2 pl-1">
                ...
                <Link to="/forgot-password" className="text-xs font-semibold text-brand-blue hover:text-brand-dark-blue">
                  Forgot password?
                </Link>
              </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full mt-8 bg-brand-blue hover:bg-brand-dark-blue disabled:bg-slate-600 text-white font-bold py-3 rounded-lg transition-all shadow-lg hover:shadow-xl disabled:shadow-none transform hover:scale-[1.01] active:scale-95"
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-[rgba(16,22,34,0.4)] text-slate-400 text-xs uppercase font-semibold">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center gap-3 px-4 py-3 bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] text-white rounded-lg hover:bg-[rgba(255,255,255,0.1)] disabled:opacity-50 transition-all"
            >
          ...
          <p className="text-center text-slate-400 mt-8">
            ...
            <Link to="/register" className="font-semibold text-brand-blue hover:text-brand-dark-blue">
              Create an account
            </Link>
          </p>
        </div>
